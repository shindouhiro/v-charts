(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend'), require('echarts-wordcloud')) :
  typeof define === 'function' && define.amd ? define(['echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend', 'echarts-wordcloud'], factory) :
  (global.VeWordcloud = factory(global.echarts));
  ...
  var wordcloud = function wordcloud(columns, rows, settings, extra) {
    ...
    var tooltip$$1 = tooltipVisible && getTooltip({ tooltipFormatter: tooltipFormatter });
  ...
  var DataEmpty = { render: function render() {
          var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "v-charts-data-empty" }, [_c('div', { staticClass: "v-charts-bg", style: { height: _vm.height } }, [_vm.flag === 'dark' ? _c('img', { attrs: { "src": require('../images/default.png') } }) : _c('img', { attrs: { "src": require('../images/default-light.png') } }), _vm._v(" "), _vm._m(0)])]);
      }, staticRenderFns: [function () {
          var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "pt30 ml30" }, [_c('p', { staticClass: "f16" }, [_vm._v("暂无数据")])]);
      }], _scopeId: 'data-v-0e992a7a',
      props: {
          flag: String,
          height: String
      }
  ...
  var dark = {
      ...
      "color": ["#89A562", "#55B2A3", "#3B775C", "#4685D1", "#4064D4", "#354DA0"],
      "textStyle": {
          color: '#A0A3A8'
      },
  ...
  var light = {
      "color": ["#36C2CF", "#70C6FF", "#4D71EC", "#3B26D9", "#2757FC ", "#14DCC3 "],
      "title": {
          "textStyle": {
              "color": "#ffffff"
          },
      ...
      "visualMap": {
          "color": ["#16937A", "#4EB183", '#63B1BA', "#C1EEE5"]
      },
      "dataZoom": [{
          "type": "inside",
          "zoomLock": false,
  ...
  var Core = {
    ...
    methods: {
      ...
      init: function init() {
        ...
        var themeName = this.themeName || this.theme || this.getSkin() || DEFAULT_THEME;
